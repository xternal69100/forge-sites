...
const order = client.addOrder({ id:'OE-DEMO-TEST', createdAt:'2026-07-17T18:00:00.000Z', family:'Hexavox Mono V2', name:'Camille Exemple', email:'camille@example.test' });
assert.equal(order.amountCHF, 0);
assert.equal(order.pack, '../downloads/Hexavox-Mono-V2-Open-Edition-v1.100.zip');
assert.deepEqual(Store.FAMILIES, ['Elanovre', 'KeraVolt Optical', 'Cervalune', 'Modulune System', 'Brisacline Display', 'Hexavox Mono V2', 'Riftora Experimental']);
