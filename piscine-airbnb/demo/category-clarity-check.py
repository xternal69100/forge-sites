...
def main() -> int:
    ...
    assert "Piscine privée · créneau de 2 h · sans hébergement" in landing, "landing: ligne constante des cartes absente"
    assert "Piscine privée · créneau de 2 h · sans hébergement" in demo, "demo: ligne constante des cartes absente"
